 ...
 * VERIFIED against the published artifact rather than transcribed:
 *
 ...
 *     unchanged since 1.0.0, which is what lets 1.2.0 install as an in-place
 *     upgrade over 1.1.0 without any till losing its pairing.
 *
